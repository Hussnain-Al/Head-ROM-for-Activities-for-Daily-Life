...
T = table(tasks', round(rom(:,1),1), round(romSD(:,1),1), round(rom(:,2),1), ...
          round(rom(:,3),1), round(100*rom(:,1)/sagRange), round(kept), ...
    'VariableNames',{'Task','FlexExt_deg','SD_deg','LatBend_deg','AxialRot_deg', ...
                     'PctSagRange','Kept_pct'});
